-- =====================================================
-- COMPLETE DATABASE SCHEMA FOR PORTFOLIO BINDER
-- =====================================================
...
-- =====================================================
-- 2. PORTFOLIOS TABLE (Updated Schema)
-- =====================================================
...
VALUES
  (
    'filmmaker1@example.com',
    'filmmaker1',
    'Alex Rivera',
    'Independent filmmaker specializing in documentary and short films.',
    'filmmaker',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=filmmaker1',
    'Los Angeles, CA'
  ),
  (
    'filmmaker2@example.com',
    'filmmaker2',
    'Jordan Lee',
    'Cinematographer and director with a passion for visual storytelling.',
    'filmmaker',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=filmmaker2',
    'New York, NY'
  ),
  (
    'filmmaker3@example.com',
    'filmmaker3',
    'Sam Chen',
    'Award-winning editor and filmmaker focused on narrative storytelling.',
    'filmmaker',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=filmmaker3',
    'Austin, TX'
  )
ON CONFLICT (email) DO NOTHING;

-- Insert sample portfolios (linking to users)
DO $$
DECLARE
  user1_id UUID;
  user2_id UUID;
...
BEGIN
  -- Get user IDs
  SELECT id INTO user1_id FROM users WHERE username = 'filmmaker1';
  SELECT id INTO user2_id FROM users WHERE username = 'filmmaker2';
  SELECT id INTO user3_id FROM users WHERE username = 'filmmaker3';
  
  -- Insert portfolios for user 1
...
-- =====================================================
-- 4. ROW LEVEL SECURITY (Optional - Disabled for now)
-- =====================================================
...
-- ✅ Portfolios table (for video uploads)
-- ✅ Sample data (3 users, 8 portfolios)
