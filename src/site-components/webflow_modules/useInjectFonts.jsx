...
const GOOGLE_WEBFONT_URL = 'https://ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js';
    ...
    React.useEffect(() => {
        ...
        if (manifest.google && manifest.google.length > 0) {
            ...
            ensureGlobalLoaded({
                ...
                onError: () => warnOnce('[DevLink] Google Fonts failed to load. If your app uses a Content Security Policy, ' +
        ...
        if (manifest.typekit?.kitId) {
            ...
            ensureGlobalLoaded({
                ...
                onError: () => warnOnce('[DevLink] Adobe Fonts failed to load on this domain. Add this domain to your ' +
